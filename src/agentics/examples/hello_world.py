...
from agentics.core.llm_connections import  watsonx_crewai_llm, ollama_turbo_llm,gemini_llm
...
async def main():
    ...
    answers = await (AG(atype=Answer, 
                        llm= gemini_llm, ## you can replace this with any llm in llm_connections
